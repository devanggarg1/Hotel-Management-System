...
class Cust_Win():
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="ADD CUSTOMER DETAILS", font=(
        ...
        lblcusref = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Customer Ref", padx=2, pady=6)
        lblcusref.grid(row=0, column=0, sticky=W)
        cust_ref = ttk.Entry(DataFrameLeft, textvariable=self.var_ref, font=(
            "arial", 13, "bold"), width=29, state=DISABLED)
        cust_ref.grid(row=0, column=1)

        cname = Label(DataFrameLeft, font=("arial", 12, "bold"),
                      text="Customer Name:", padx=2, pady=6)
        cname.grid(row=1, column=0, sticky=W)
        txtcname = ttk.Entry(DataFrameLeft, textvariable=self.var_cust_name, font=(
            "arial", 13, "bold"), width=29)
        txtcname.grid(row=1, column=1)

        lblmname = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Mother Name:", padx=2, pady=6)
        lblmname.grid(row=2, column=0, sticky=W)
        txtmname = ttk.Entry(DataFrameLeft, textvariable=self.var_mother, font=(
            "arial", 13, "bold"), width=29)
        txtmname.grid(row=2, column=1)

        label_gender = Label(DataFrameLeft, font=(
        ...
        lblPostCode = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="PostCode:", padx=2, pady=6)
        lblPostCode.grid(row=4, column=0, sticky=W)
        txtPostCode = ttk.Entry(DataFrameLeft, textvariable=self.var_post, font=(
            "arial", 13, "bold"), width=29)
        txtPostCode.grid(row=4, column=1)

        lblMobile = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Mobile:", padx=2, pady=6)
        lblMobile.grid(row=5, column=0, sticky=W)
        txtMobile = ttk.Entry(DataFrameLeft, textvariable=self.var_mobile, font=(
            "arial", 13, "bold"), width=29)
        txtMobile.grid(row=5, column=1)

        lblEmail = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Email:", padx=2, pady=6)
        lblEmail.grid(row=6, column=0, sticky=W)
        txtEmail = ttk.Entry(DataFrameLeft, textvariable=self.var_email, font=(
            "arial", 13, "bold"), width=29)
        txtEmail.grid(row=6, column=1)

        lblNationality = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Nationality:", padx=2, pady=6)
        ...
        lblIdProof = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Id Proof Type:", padx=2, pady=6)
        ...
        lblIdNumber = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Id Number:", padx=2, pady=6)
        lblIdNumber.grid(row=9, column=0, sticky=W)
        txtIdNumber = ttk.Entry(DataFrameLeft, textvariable=self.var_id_number, font=(
            "arial", 13, "bold"), width=29)
        txtIdNumber.grid(row=9, column=1)

        lblAddress = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Address:", padx=2, pady=6)
        lblAddress.grid(row=10, column=0, sticky=W)
        txtAddress = ttk.Entry(DataFrameLeft, textvariable=self.var_adderss, font=(
            "arial", 13, "bold"), width=29)
        ...
        # ===================================ButtonFrame=====================================
        btnAddData = Button(ButtonFrame, text="Save", command=self.add_data, font=(
            "arial", 11, "bold"), width=10, bg="black", fg="gold")
        btnAddData.grid(row=0, column=0, padx=1)

        btnShowData = Button(ButtonFrame, text="Update", command=self.update_data, font=(
            "arial", 11, "bold"), width=10, bg="black", fg="gold")
        btnShowData.grid(row=0, column=1, padx=1)

        btnUpdate = Button(ButtonFrame, text="Delete", command=self.mDelete, font=(
            "arial", 11, "bold"), width=10, bg="black", fg="gold")
        ...
        # =======table&Scrollbar=====================================================================================
        Table_frame = LabelFrame(self.root, text="View Customer Details & Search", font=(
    ...
    def add_data(self):
        if self.var_ref.get() == "" or self.var_mobile.get() == "":
            ...
            try:
                ...
                messagebox.showerror(
                    "Error", f" Must be enter Integer number, is Primery Key :{str(es)}", parent=self.root)
    # =========Update Data==================
    ...
    def search_data(self):
        conn = mysql.connector.connect(
            host='localhost', username='root', password='root', database='mydata')
        my_cursor = conn.cursor()
        my_cursor.execute("select * from hotel where " + str(self.serch_var.get()
